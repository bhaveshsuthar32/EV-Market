                  ...
                  <div className="grid grid-cols-6 py-2 container">
                    <div className="col-span-2 border-t-[1px]">
                      <ul className="">
                        ...
                        <li className="border-b-[1px] pt-3 pb-1">Speed </li>
                        <li className="border-b-[1px] pt-3 pb-1">Battery</li>
                        <li className="border-b-[1px] pt-3 pb-1">
                          Motor Power
                        </li>
                        <li className="border-b-[1px] pt-3 pb-1">Tyer</li>
                      </ul>
                    </div>
                    <div className=" col-span-4 border-t-[1px] ">
                      <ul>
                        <li className="border-b-[1px] pt-3 pb-1">abc</li>
                        <li className="border-b-[1px] pt-3 pb-1">abc</li>
                        <li className="border-b-[1px] pt-3 pb-1">abc</li>
                        <li className="border-b-[1px] pt-3 pb-1">abc</li>
                        <li className="border-b-[1px] pt-3 pb-1">abc</li>
