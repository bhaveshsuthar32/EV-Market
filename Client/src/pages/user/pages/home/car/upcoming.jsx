          ...
          <SwiperSlide className=''>
            <div className="card card-compact bg-base-100 lg:w-[300px] w-60 p-0 shadow-md rounded-lg">
              ...
              <div className="p-2  md:p-6 leading-4 h-[70px] lg:h-[90px] my-0">
                <h2 className="lg:card-title font-semibold text-[14px] lg:text-[18px] mt-0">Ford Mustang</h2>
                <p className='text-[14px]  lg:text-[17px]'>8,00,000</p>
              </div>
            </div>
          </SwiperSlide>
