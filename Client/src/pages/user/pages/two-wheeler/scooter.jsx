                ...
                <div className=" listgrid-sidebar">
                  <div className="count-search mb-[20px] ">
                    <h4 className="text-[20px] font-semibold">
                      E-Scooter for Sale
                      <span className="text-[16px]"> (Showing {scooter.length})</span>
                    </h4>
                  </div>
                  <div className="grid-view listgrid-sidebar row">
                    {scooter.map((scooterInfo) => (
                      <div className="col-12 col-lg-3 col-md-4 col-sm-12 " key={scooterInfo._id}>
                        <div className="card">
                          <div className="blog-widget">
                            <div className=" text-center p-2">
                              <Link to={`/two-details/${scooterInfo._id}`}>
                                <img
                            ...
                            <div className="bloglist-content">
                              <div className="card-body p-3">
                                <div className="amount-details mb-2 ps-2 fw-bold text-dark">
                                  <span>{scooterInfo.vehicle_name}</span>
                                ...
                                <div className="blogfeaturelink m-0">
                                  <div className="blog-features ps-2 fw-bold mb-2">
                                    <p>₹ {scooterInfo.showroom_price}</p>
                                  </div>
                                </div>
                                <div className="blog-location-details grid grid-cols-3 text-center text-xs text-black ">
                                  <div>
                                    <img
                                ...
                                <div className="blog-location-details text-dark grid grid-cols-3 text-center text-xs mt-[-20px]">
                                  <div>{scooterInfo.motor_power}</div>
                                  <div>{scooterInfo.range}</div>
                                  <div>{scooterInfo.battery}</div>
                                ...
                                <div className="blog-location-details text-dark grid grid-cols-3 text-center text-xs mt-[-20px]">
                                  <div>{scooterInfo.charging_time}</div>
                                  <div>{scooterInfo.color}</div>
                                  <div>{scooterInfo.speed}</div>
                                </div>
                                <div className="amount-details">
                                  <div className="amount">
                                    <Link className="validrate" to={`/two-details/${scooterInfo._id}`}>
