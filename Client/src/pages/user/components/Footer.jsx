          ...
          <div className="row">
            ...
            <div className="col-lg-2 col-md-6">
              ...
              <div className="footer-widget footer-menu">
                ...
                <ul>
                  <li>
                    <a href="/about.html">EV Bike</a>
                  </li>
                  <li>
                    <a href="javascript:void(0)">EV Scooter</a>
                  </li>
                  <li>
                    <a href="/service-details.html">EV Car</a>
                  </li>
                  <li>
                    <a href="javascript:void(0)">EV Bicycle</a>
                  </li>
            ...
            <div className="col-lg-2 col-md-6">
              {/* Footer Widget */}
              <div className="footer-widget footer-menu">
                <h2 className="footer-title">EV Contact</h2>
                <ul>
                  <li>
                    <a href="#">About Us</a>
                  </li>
